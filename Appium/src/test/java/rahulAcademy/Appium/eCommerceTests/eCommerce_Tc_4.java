...
public class eCommerce_Tc_4 extends BaseTestServer {
...
//		}
		driver.context("WEBVIEW_com.androidsample.generalstore");//Webview can change! and we need to set chrome driver
		driver.findElement(By.className("truncate")).sendKeys("Olas");
		driver.findElement(By.id("input")).sendKeys(Keys.ENTER);
		driver.pressKey(new KeyEvent(AndroidKey.BACK));
		driver.context("NATIVE_APP"); //To set again the context on the app
		Thread.sleep(3000);
	}
